        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    <a href="{{ route('home') }}" class="list-group-item list-group-item-action @if(Request::routeIs('home')) active @endif">Home</a>
                    <a href="{{ route('products') }}" class="list-group-item list-group-item-action @if(Request::routeIs('products')) active @endif">Products</a>
                    <a href="{{ route('pricing') }}" class="list-group-item list-group-item-action @if(Request::routeIs('pricing')) active @endif">Pricing</a>
                    <a href="{{ route('contact') }}" class="list-group-item list-group-item-action @if(Request::routeIs('contact')) active @endif">Contact</a>
                </div>
            </div>
            <!-- Page Content -->
            <div class="col-md-9">
